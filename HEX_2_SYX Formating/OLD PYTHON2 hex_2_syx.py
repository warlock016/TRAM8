...
#preamble for tram8
sysex_preamble = 'T8FW'
sysex_version  = binascii.unhexlify('05') #set version 
...
sysex_start = binascii.unhexlify('F000297F') 

sysex_fill = ('00' * 451) #ascii zeros for processor downtime while flashing
sysex_endhex = binascii.unhexlify('3A303030303030303146460D0AF7')
#['F0', '00','29','7F'] 
